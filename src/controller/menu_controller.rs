...
use crate::model::menu_model::{SysMenuAddPayload, SysMenuPage, SysMenuPagePayload};
...
pub async fn add_menu(payload:JsonBody<SysMenuAddPayload>,depot:&mut Depot)->Res<()>{
